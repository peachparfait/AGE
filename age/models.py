...
class Furn(models.Model):
	...
	img = models.ForeignKey(FurnImage,on_delete=models.PROTECT,null=True,default=1)
...
class HomeElecApp(models.Model):
	...
	img = models.ForeignKey(ElecImage,on_delete=models.PROTECT,null=True)
	story = models.TextField('ストーリー',max_length=1000,default='')
	birthday = models.DateField('誕生日（購入日など）',default=datetime.date.today())
...
class Aniversary(models.Model):
	...
	img = models.ForeignKey(AnnivImage,on_delete=models.PROTECT,null=True)
	story = models.TextField('ストーリー',max_length=1000,default='')
...
class Other(models.Model):
	...
	img = models.ForeignKey(OtherImage,on_delete=models.PROTECT,null=True)
	story = models.TextField('ストーリー',max_length=1000,default='')
	birthday = models.DateField('誕生日（購入日など）',default=datetime.date.today())
...
class Clothes(models.Model):
	...
	img = models.ForeignKey(ClothImage,on_delete=models.PROTECT,null=True)
	story = models.TextField('ストーリー',max_length=1000,default='')
	birthday = models.DateField('誕生日（購入日など）',default=datetime.date.today())
